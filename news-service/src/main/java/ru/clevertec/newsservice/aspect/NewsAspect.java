...
public class NewsAspect {
    ...
    @Around("joinToCache() && execution( public * ru.clevertec.newsservice.service.impl.NewsServiceImpl.findById(..))")
     ...
     */
    @SuppressWarnings("unchecked")
    @Around("joinToCache() && execution(public * ru.clevertec.newsservice.service.impl.NewsServiceImpl.update(..))")
     ...
     * @param joinPoint represents the execution of the method.
     */
    @Around("joinToCache() && execution(public * ru.clevertec.newsservice.service.impl.NewsServiceImpl.delete(..))")
